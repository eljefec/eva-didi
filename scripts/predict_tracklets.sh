...
python python/squeezedet.py --bag_dir /data/bags/didi-round2/release/car/testing --do tracklet --include_car --out_dir $OUT_DIR/test
python python/squeezedet.py --bag_file /data/bags/didi-round2/release/pedestrian/ped_test.bag --do tracklet --include_ped --out_dir $OUT_DIR/test

# Generate tracklets for training set.
python python/squeezedet.py --bag_file /data/bags/didi-round2/release/car/training/suburu_leading_front_left/suburu11.bag --do tracklet --include_car --out_dir $OUT_DIR
...
python python/squeezedet.py --bag_file /data/bags/didi-round2/release/pedestrian/ped_train.bag --do tracklet --include_ped --out_dir $OUT_DIR
...
python python/squeezedet.py --bag_file /data/bags/didi-round2/release/car/training/bmw_following_long/bmw02.bag --do tracklet --include_car --out_dir $OUT_DIR
mkdir $OUT_DIR/bmw02
