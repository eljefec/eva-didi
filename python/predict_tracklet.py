...
def predict_tracklet(model_file, bag_file, metadata_path, output_file, pickle_file = None):
    ...
    input_generator = TrainDataGenerator(datastream, include_ground_truth = False)

    batch_size = 64
    predictions = model.predict_generator(input_generator.generate(batch_size),
                                          input_generator.get_count() / batch_size)
...
if __name__ == '__main__':
    model_file = 'checkpoints/model_2017-05-30_21h37m52e03-vl100.52.h5'
